...
#ifdef _TEST_AVL
#include "avl_adpt.h"
#elif defined(_TEST_LINUXRB)
#include "rbtree_adpt.h"
#endif
...
#define MM_PGTBL_LOCK(aspace)
#define MM_PGTBL_UNLOCK(aspace)
...
uintptr_t rt_kmem_pvoff(void);

void rt_kmem_pvoff_set(uintptr_t pvoff);

int rt_kmem_map_phy(void *va, void *pa, size_t length, size_t attr);
